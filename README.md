...
## Link the repository to your personal GitHub account
...
## Commit the files that you've staged in your local repository(use semantic commits - see the assessment document for suggested commit messaging).
...
## Tailwind CSS components (Phase 3)
    - Sticky headers
    - Horizontal cards
    - Image anchors
    - Simple footer